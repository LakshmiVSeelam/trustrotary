...
export class TeamComponent implements OnInit {
  ...
  constructor() { 
    let data = [
      ...
      {'grp': 2, 'name': 'Rtn. J. Hari Babu', 'role': 'Blood Bank Project <br> Co-Ordinator', 'img': 'haribabu'},
      {'grp': 2, 'name': 'Rtn. C.P.V. Ramanujam', 'role': 'physiotherapy Project <br> Co-Ordinator', 'img': 'ramanujam'},
      {'grp': 2, 'name': 'Rtn. G.S. Murthy', 'role': 'physiotherapy Project <br> Co-Ordinator', 'img': 'smurthy'},
      {'grp': 2, 'name': 'Rtn. V. S.N. Murty (Suryam)', 'role': 'skill development Project <br> Co-Ordinator', 'img': 'murty'},
      {'grp': 2, 'name': 'Rtn. Jayesh Desai', 'role': 'skill development Project <br> Co-Ordinator', 'img': 'jayesh'},
