...
export class AboutComponent implements OnInit {
  ...
  constructor() {
    this.sections = [
      ...
      {'name': 'The Rotary Foundation (TRF)', 'logo': 'rfi_logo.png','desc': 'The Rotary Foundation is a non-profitable organisation that supports the efforts of RI to achieve world understanding and peace through International humanitarian, educational and cultural programs. It is supported solely by voluntary contribution. Our club has contributed more than One crore rupees to Rotary Foundation.', 'link': 'https://www.rotary.org/en'}
    ]
  }
